...
const menu1 = document.querySelector("#app-menu1-btn"); 
const menu2 = document.querySelector("#app-menu2-btn"); 
const addUser = document.querySelector("#app-adduser-btn"); 
const deleteUser = document.querySelector("#app-deleteuser-btn"); 
const account = document.querySelector("#app-account-btn"); 
...
function startApp() {
  ...
  username.innerHTML = `Open Data, ${new Date().getFullYear()}`; 
  ...
  function handlerForm(e) {
    ...
    username.innerHTML = `Open Data by ${currentUser}, ${new Date().getFullYear()}`;
    ...
    menu1.addEventListener("click", handlerMenu1); 
    menu2.addEventListener("click", handlerMenu2); 
    addUser.addEventListener("click", handlerAddUser); 
    deleteUser.addEventListener("click", handlerDeleteUser); 
    account.addEventListener("click", handlerAccount); 
    ...
    function handlerMenu1() {
      content.innerHTML = menu1Template; 
      closePopupUserMenu();
    }
    ...
    function handlerMenu2() {
      content.innerHTML = menu2Template; 
      closePopupUserMenu();
    }
    ...
    function handlerAccount() {
      content.innerHTML = myAccountTemplate; 
      closePopupUserMenu();
    }
